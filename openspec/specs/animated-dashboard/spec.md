# animated-dashboard Specification

## Purpose
The app-wide motion sweep on the dashboard: spring KPI count-ups, animated (FLIP) list transitions for the tasks/people/tools lists, shimmer skeleton loading states, route transitions, and playful micro-interactions and reward moments (fully-staffed pop, day-complete celebration). All motion honors the centralized motion preference.
