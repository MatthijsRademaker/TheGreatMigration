...
### Requirement: Each schedule task card SHALL expose canonical dashboard fields with stable persisted identifiers
...
### Requirement: Persisted schedule data SHALL be date-based and remain separate from backlog task storage
