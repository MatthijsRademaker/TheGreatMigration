# backend-service Specification (Delta)

## Purpose

Update the canonical `openspec/specs/backend-service/spec.md` to reflect database initialization at startup and dependency injection for handlers.
